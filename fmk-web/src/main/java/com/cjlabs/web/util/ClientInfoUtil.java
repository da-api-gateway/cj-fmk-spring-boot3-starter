...
public class ClientInfoUtil {
    ...
    public static String getClientIp(HttpServletRequest request) {
        ...
        return StringUtils.isNotBlank(remoteAddr) ? remoteAddr : "unknown";
    }
    ...
    public static void parseUserAgent(String userAgent, ClientInfo clientInfo) {
        if (StringUtils.isBlank(userAgent) || clientInfo == null) {
            return;
        }
        ...
        try {
            ...
            log.info("ClientInfoUtil|parseUserAgent|解析完成|deviceType={}|os={}|browser={}",
                    deviceType, operatingSystem, clientInfo.getBrowser());
    ...
    private static String getWindowsVersion(String ntVersion) {
        switch (ntVersion) {
            case "10.0": return "10/11";  // Windows 10 和 11 都是 NT 10.0
            case "6.3": return "8.1";
            case "6.2": return "8";
            case "6.1": return "7";
